...
interface CreateFanModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: (formData: FanFormData) => void; // Use the typed interface instead of any
}

export default function CreateFanModal({ isOpen, onClose, onCreate }: CreateFanModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-3xl shadow-2xl w-[95vw] md:w-[800px] p-8 relative max-h-[90vh] overflow-y-auto">
        ...
        <h2 className="text-2xl font-bold text-[#028b6e] mb-8 text-center">Add New Fan</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-medium text-gray-700">Verified Email</label>
            <div className="p-3 border rounded-xl flex items-center justify-between">
              <p className="text-xs text-gray-500">Turn on if email account verified</p>
